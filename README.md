...
5. Runs a grep scan for red flag patterns (eval, os.system, credential theft...)
6. Analyzes runtime scripts and hooks
7. Issues a clear verdict: ✅ Safe / ⚠️ Caution / 🚨 Risk
